...
const TestimonialsSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-4 md:my-16 my-10 gap-8 mt-14'>
          ...
          <div key={index} className='text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
            ...
            <div className='p-5 pb-7'>
                <div className='flex gap-0.5'>
                  {[...Array(5)].map((_, i)=>{
                    return <img key={i} src={i < Math.floor(testimonial.rating) ? assets.star : assets.star_blank} alt='stars' className='w-3.5 h-5'/>
                  })}
                </div>
